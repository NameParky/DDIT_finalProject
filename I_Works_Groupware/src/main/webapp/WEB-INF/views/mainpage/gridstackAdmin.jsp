...
<input type="hidden" value = "${ajaxMap.start.fab }" id="startFeb"/>
...
<input type="hidden" value = "${ajaxMap.end.fab }" id="endFeb"/>
	...
	$(document).on('change', '#chart3select1', function() {
		...
		$.ajax({
			...
			success : function(result) {
				...
				monthData.push(result.chartRes.fab);
