		...
		success : function(result){
			if(result != null) {
				...
				if(images.includes(item.fileType)){
		        	...
		        	str += '<span class="fw-bold cancleSpan" data-value="' + item.fileSavename + '" style="cursor:pointer">' + addIcon 
		        	+ item.fileOrgname + '&nbsp;&nbsp;&nbsp;<span class="cancleFile" style="color:red; cursor:pointer;">x</span></span>';
